                ...
                <?php if(!empty($categoryNews)) { ?>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="col-sm-12 col-md-12">
                            <div class="thumbnail">
                                <a href = "/news/<?=$categoryNews[0]['id_news']?>"><img class="img" style="height: 350px; width: 100%" src="/images/<?=$categoryNews[0]['id_news']?>.jpg"></a>
                                <div class="caption" style="height: 180px">
                                    <h3><a href = "/news/<?=$categoryNews[0]['id_news']?>"><?=$categoryNews[0]['title']?></a></h3>
                                    <em><?=$categoryNews[0]['date']; unset($categoryNews[0])?></em>
                                </div>
                            </div>
                        </div>
                    </div>
